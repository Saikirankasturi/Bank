...
<html lang="en">
  ...
  ?>
      ...
      <section>
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="createuser.php"><button style="background-color :#FF4C4F;">Create a User</button></a>
                  </div>
                  <div class="col-md act">
                  <span class="user-icon"><i class="fas fa-rupee-sign fa-10x"></i></span>
                    <br>
                    <a href="transfermoney.php"><button style="background-color :#FF4C4F;">Make a Transaction</button></a>
                  </div>
                  <div class="col-md act">
                  <span class="user-icon"><i class="fas fa-money-check fa-10x"></i></span>
                    <br>
                    <a href="transactionhistory.php"><button style="background-color :#FF4C4F;">Transaction History</button></a>
                  </div>
            </div>
      </div>
      </section>
      ...
      <section>
      <div class="saikiran">
        <p class="sectionTag text-big">IDBI Bank</p>
      ...
      <p><a href="https://github.com/Saikirankasturi/Kasturi"><span class="git"><i class="fab fa-github"></i></span></a> <b> Saikiran Kasturi</b> <br> The Sparks Foundation</p>
      <p>
        Copyright &copy;2021 www.idbibank.com - All Rights Reserved
    </p>
      </footer>
...
body {
  background-image:url('img/citi.jpg');
